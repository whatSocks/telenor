...
//accounts
CREATE (`account1`:account {name:'1'}),
	(`account2`:account {name:'2'}),
	(`account3`:account {name:'3'}),
	(`account4`:account {name:'4'}),
	(`account5`:account {name:'5'}),
	(`account6`:account {name:'6'}),
	(`account7`:account {name:'7'}),
	(`account8`:account {name:'8'}),
	(`account9`:account {name:'9'}),
	(`account10`:account {name:'10'}),
	(`account11`:account {name:'11'}),
	(`account12`:account {name:'12'})
